import { User, Ticket, FAQ, Notification as NotificationType, Message, Statistics, TicketActionLog } from '../types';
...
export const mockActionLogs: TicketActionLog[] = [
  {
    id: 'log1',
    ticketId: '1001',
    action: 'created',
